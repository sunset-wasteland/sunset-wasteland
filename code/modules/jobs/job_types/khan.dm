...
/datum/outfit/loadout/khanpointmanplus
...
/datum/job/khan/kipchak
	...
	loadout_options = list(
		/datum/outfit/loadout/watchcaptain,
		/datum/outfit/loadout/expforeman,
		/datum/outfit/loadout/ambusher,
		)
