/////////
// Old Berserker Rites, slightly modified.
// Not exclusive to the player who gets it as fluff, if staff intervene.
// Or, y'know, we return it normally. At some point.
// Rename the martial art if that's what you intend.
/////////
