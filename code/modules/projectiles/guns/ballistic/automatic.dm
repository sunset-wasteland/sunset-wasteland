...
//Police Rifle Unique        Keywords: Unique, 5mm, Semi-Auto, 30 round magazine
/obj/item/gun/ballistic/automatic/assault_carbine/policerifle/karakov
	name = "Foreigner"
	desc = "A post-war reproduction Rifle that has been repaired and rebuilt with pre-war technology, held together with riveting and prayers."
	icon_state = "rifle-police-k"
	autofire_shot_delay = 2.2
	spread = 7 //Less Inaccurate as it's meant to be upgraded
	extra_penetration = -0.9 //replaced parts so its still got the penetration
	extra_damage = 1
