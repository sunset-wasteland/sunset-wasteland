...
<body>
	...
	<p>The Brotherhoods chief goal is to seek out, acquire, and preserve advanced technology. Though they focus primarily on fusion-powered weaponry, such as Power Armor and Micro Fusion Cells, as well as the weapons that require them, the Brotherhood could feasibly get involved with any suitably dangerous pre-war technology.</p>
	...
	<p>What this means is simple: If a wastelander is producing and selling or stockpiling MFC weaponry, or if a regiment of a faction is using primarily MFC weaponry, THEN it is the Brotherhoods duty to get involved. </p>
	<p>Power Armor is a greyer area. Each Castellan or Knight-Commander may take a different stance to the issue, but it is to be handled very delicately: If the group in question is capable of reproducing the armor, or is willing to destroy it, the commanding officer is encouraged to take action, but may deem it unnecessary or unwise to do so in the right circumstances.</p>
	...
	<h3Through discourse, we gain the strength of our Brothers minds. Question orders if you must, and refuse them only if they violate these tenets.</h3>
	<p>If you are given an order you believe will harm the Brotherhoods mission, you are allowed to question it. If the order would violate the Codex, you may refuse to carry it out until it is interpreted otherwise by the Baron. </p>
