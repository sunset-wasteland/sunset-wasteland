/proc/possess(obj/O in world)
	...
	O.AddElement(/datum/element/weather_listener, /datum/weather/rain, ZTRAIT_STATION, GLOB.rain_sounds)
...
/proc/release()
	...
	usr.control_object.RemoveElement(/datum/element/weather_listener, /datum/weather/rain, ZTRAIT_STATION, GLOB.rain_sounds)
