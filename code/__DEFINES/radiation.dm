...
#define RAD_MOB_HAIRLOSS 1800						// How much stored radiation to check for hair loss

#define RAD_MOB_MUTATE 1950							// How much stored radiation to check for mutation
