...
/datum/reagent/medicine/neurostim/on_mob_life(mob/living/carbon/M)
	...
	ADD_TRAIT(M, TRAIT_ABDUCTOR_ANTAGONIST, src)
	ADD_TRAIT(M, ABDUCTOR_VEST_TRAIT, src)
	ADD_TRAIT(M, TRAIT_TECHNOPHREAK, src)
	ADD_TRAIT(M, TRAIT_ABDUCTOR_SCIENTIST_TRAINING, src)
    ADD_TRAIT(M, TRAIT_ABDUCTOR_TRAINING, src)
