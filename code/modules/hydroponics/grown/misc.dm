...
/obj/item/seeds/starthistle/corpse_flower/process(delta_time)
	...
	stank.adjust_moles(GAS_MIASMA,(yield + 6)*0.14*delta_time) // 0.14 = 7*0.02, this process is only being called about 2/7 as much as corpses so this is 12-32 times a corpses
