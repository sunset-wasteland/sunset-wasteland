...
/obj/item/clothing/suit/armor/f13/raider
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 0)
	strip_delay = 40
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/raider/supafly //melee spec
	...
	armor = list("melee" = 45, "bullet" = 20, "laser" = 20, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 0)
	slowdown = 0.01
	icon_state = "supafly"
	item_state = "supafly"
...
/obj/item/clothing/suit/armor/f13/raider/blastmaster
	...
	armor = list("melee" = 40, "bullet" = 15, "laser" = 40, "bio" = 0, "bomb" = 90, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 0)
	flash_protect = 2
...
/obj/item/clothing/suit/armor/f13/raider/badlands
	...
	icon_state = "badlands"
	item_state = "badlands"
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/raider/painspike
	...
	armor = list("melee" = 40, "bullet" = 30, "laser" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/raider/iconoclast
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "bio" = 0, "rad" = 60, "fire" = 25, "acid" = 25, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/raider/raidermetal
	...
	armor = list("melee" = 55, "bullet" = 35, "laser" = 55, "energy" = 25, "bomb" = 45, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/legion
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 0)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/legion/recruit
	...
	armor = list("melee" = 33, "bullet" = 25, "laser" = 5, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 0)
	slowdown = 0.04
...
/obj/item/clothing/suit/armor/f13/legion/recruit/decan
	...
	armor = list("melee" = 40, "bullet" = 30, "laser" = 5, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/legion/prime
	...
	armor = list("melee" = 45, "bullet" = 30, "laser" = 10, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/legion/prime/decan
	...
	armor = list("melee" = 45, "bullet" = 35, "laser" = 10, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/legion/vet
	...
	armor = list("melee" = 55, "bullet" = 37, "laser" = 25, "energy" = 15, "bomb" = 30, "bio" = 5, "rad" = 5, "fire" = 35, "acid" = 0, "wound" = 0)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/legion/heavy
	...
	armor = list("melee" = 60, "bullet" = 46, "laser" = 25, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0, "wound" = 10)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/legion/vet/explorer
	...
	armor = list("melee" = 37, "bullet" = 24, "laser" = 15, "energy" = 10, "bomb" = 40, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/legion/vet/vexil
	...
	armor = list("melee" = 57, "bullet" = 37, "laser" = 42, "energy" = 20, "bomb" = 25, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 10)
	slowdown = 0.12
...
/obj/item/clothing/suit/armor/f13/legion/venator
	...
	armor = list("melee" = 50, "bullet" = 35, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 0)
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 5)
...
/obj/item/clothing/suit/armor/f13/legion/rangercent //speed and bullet resist, sacrifices all else
	...
	armor = list("melee" = 27.5, "bullet" = 62.5, "laser" = 25, "energy" = 15, "bomb" = 35, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0, "wound" = 0)
	slowdown = 0.03
...
/obj/item/clothing/suit/armor/f13/legion/vet/explorercanada
	...
	armor = list("melee" = 45, "bullet" = 35, "laser" = 15, "energy" = 10, "bomb" = 40, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 0)
	slowdown = 0.03
/*
...
/obj/item/clothing/suit/armor/f13/utilityvest
	...
	icon = 'icons/fallout/clothing/suits_utility.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/suit_utility.dmi'
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 10, "bomb" = 15, "bio" = 10, "rad" = 20, "fire" = 30, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/utilityvest/logisticsofficer //same as his beret
	...
	armor = list("melee" = 15, "bullet" = 50, "laser" = 40, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor
	...
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 25, "bullet" = 42, "laser" = 40, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 10)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/ncrarmor/reserve
	...
	item_state = "ncr_infantry_vest"
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 20, "bullet" = 30, "laser" = 10, "energy" = 20, "bomb" = 30, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/reinforced
	...
	armor = list("melee" = 25, "bullet" = 44, "laser" = 40, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 10)
	slowdown = 0.12
...
/obj/item/clothing/suit/armor/f13/ncrarmor/reinforced/engineer
	...
	armor = list("melee" = 25, "bullet" = 44, "laser" = 40, "energy" = 20, "bomb" = 85, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/mantle/reinforced/trenchraider
	...
	armor = list("melee" = 40, "bullet" = 42, "laser" = 40, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/lieutenant
	...
	armor = list("melee" = 40, "bullet" = 50, "laser" = 50, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/captain/ncr_officer_coat
	...
	armor = list("melee" = 25, "bullet" = 50, "laser" = 45, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 0)
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 5)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/ncr_dressjack
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 0)
...
/obj/item/clothing/suit/toggle/armor/f13/rangerrecon
	...
	armor = list("melee" = 35, "bullet" = 45, "laser" = 25, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 0)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/trailranger
	...
	armor = list("melee" = 35, "bullet" = 40, "laser" = 35, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 0)
	slowdown = 0.03
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 4)
...
/obj/item/clothing/suit/armor/f13/combat/ncr_patrol
	...
	armor = list("melee" = 30, "bullet" = 45, "laser" = 40, "energy" = 20, "bomb" = 55, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/rangercombat
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	slowdown = 0.01
	armor = list("melee" = 40, "bullet" = 50, "laser" = 40, "energy" = 15, "bomb" = 55, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 20, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/headscribe
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 10, "bullet" = 35, "laser" = 35, "energy" = 40, "bomb" = 36, "bio" = 50, "rad" = 69, "fire" = 10, "acid" = 70, "wound" = 0)
...
/obj/item/clothing/suit/f13/scribe
	...
	armor = list("melee" = 10, "bullet" = 25, "laser" = 25, "energy" = 10, "bomb" = 16, "bio" = 100, "rad" = 0, "fire" = 0, "acid" = 0, "wound" = 0)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/f13/elder
	...
	item_state = "elder"
	body_parts_covered = CHEST|ARMS|LEGS
	armor = list("melee" = 20, "bullet" = 25, "laser" = 25, "energy" = 10, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0, "wound" = 0)
	allowed = list(/obj/item/gun)
...
/obj/item/clothing/suit/armor/f13/combat/brotherhood
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 40, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/combat/brotherhood/senior
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 40, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/combat/brotherhood/captain
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 60, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/town
	...
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list("melee" = 33, "bullet" = 25, "laser" = 33,  "energy" = 25, "bomb" = 20, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/town/mayor
	...
	armor = list("melee" = 40, "bullet" = 35, "laser" = 40, "energy" = 30, "bomb" = 25, "bio" = 15, "rad" = 10, "fire" = 15, "acid" = 5, "wound" = 0)
	slowdown = 0.08
...
/obj/item/clothing/suit/armor/f13/town/sheriff
	...
	armor = list("melee" = 45, "bullet" = 50, "laser" = 45,  "energy" = 35, "bomb" = 30, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10, "wound" = 10)
	slowdown = 0.12
...
/obj/item/clothing/suit/armor/f13/town/deputy
	...
	armor = list("melee" = 45, "bullet" = 33, "laser" = 45,  "energy" = 35, "bomb" = 30, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10, "wound" = 0)
...
/obj/item/clothing/suit/armor/vest/oasis
	...
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
	armor = list("melee" = 15, "bullet" = 45, "laser" = 15,  "energy" = 30, "bomb" = 40, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/metalarmor/steelbib/oasis
	...
	armor = list( "melee" = 30, "bullet" = 50, "laser" = 30, "energy" = 15, "bomb" = 20, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 10)
	slowdown = 0.1
	strip_delay = 5
...
/obj/item/clothing/suit/armor/khan_jacket
	...
	armor = list("melee" = 30, "bullet" = 25, "laser" = 25,  "energy" = 25, "bomb" = 30, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10, "wound" = 0)
	slowdown = 0.05
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/armor/f13/tribe_armor
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 25, "bomb" = 25, "bio" = 70, "rad" = 65, "fire" = 80, "acid" = 100, "wound" = 0)
	slowdown = 0.04
...
/obj/item/clothing/suit/armor/f13/tribe_heavy_armor
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 35, "energy" = 30, "bomb" = 55, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30, "wound" = 10)
	slowdown = 0.10
...
/obj/item/clothing/suit/armor/f13/lightcloak
	...
	item_state = "lightcloak"
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 25, "bomb" = 25, "bio" = 70, "rad" = 65, "fire" = 80, "acid" = 100, "wound" = 0)
	slowdown = 0.025
...
/obj/item/clothing/suit/armor/f13/power_armor/t45b/tribal
	...
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 65, "bullet" = 65, "laser" = 65, "energy" = 20, "bomb" = 50, "bio" = 60, "rad" = 50, "fire" = 80, "acid" = 0, "wound" = 20)
	slowdown = 0.3
...
/obj/item/clothing/suit/f13/police
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 20, "bio" = 5, "rad" = 0, "fire" = 15, "acid" = 5, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/enclave/marine
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 50, "bullet" = 50, "laser" = 40, "energy" = 25, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 10)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/usmcriot
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 50, "bullet" = 50, "laser" = 40, "energy" = 22, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/enclavetrenchcoat
	...
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 22, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 0)
...
/obj/item/clothing/suit/armor/f13/environmentalsuit
	...
	armor = list("melee" = 25, "bullet" = 15, "laser" = 45, "energy" = 33, "bomb" = 45, "bio" = 100, "rad" = 100, "fire" = 50, "acid" = 10, "wound" = 0)
	strip_delay = 60
...
/obj/item/clothing/suit/armor/f13/town/embroidered
	...
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 40, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 0)
